// added slider and commands to change the temperature and maxtoken
// able to calculate credit and store the used token in eeprom
...
const char* chatgpt_token = "sk-hs..........";
...
void updatecredit() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    Serial.println("$" + String(creditUsed));
    Blynk.virtualWrite(V4, "$" + String(creditUsed));
  }
}
