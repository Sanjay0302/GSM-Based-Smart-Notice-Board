//added speed control via v6
// added delay control via v4
// added reset button via v7
// added text display in blynk and max led matrix
// delay with 1000ms reffrence 
// pause with 1000ms reffrence
...
// storage elemnet //rotate algorithm
BLYNK_WRITE(V5) {
