 // Just minor changes in animlist for only scrolling text message 
  ...
  {   //{anim_in,anim_out,textout,speed,pause,justify}
      { PA_SCROLL_LEFT,PA_SCROLL_LEFT ,message1,3,2,PA_LEFT},
      { PA_SCROLL_LEFT,PA_SCROLL_LEFT, message2,3,2,PA_CENTER},
      { PA_SCROLL_LEFT,PA_SCROLL_LEFT, message3,3,2,PA_CENTER},
